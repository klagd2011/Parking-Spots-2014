 ...
 * SouthLot.java
 *
 * Created on May 5, 2014, 9:38:37 AM
 */
/**
 *
 * @author S500900
 */
public class SouthLot extends javax.swing.JFrame {

    ArrayList<Integer> usedSpots;
    int[] possibleSpaces;

    /** Creates new form SouthLot */
    public SouthLot() throws IOException {
        initComponents();
    ...
    private void updateSpots() {
        int[] possible_spaces = new int[517 - usedSpots.size()];
        int index = 0;
        for (int i = 1; i < 518; i++) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new SouthLot().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(SouthLot.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
