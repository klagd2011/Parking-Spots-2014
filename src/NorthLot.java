 ...
 * NorthLot.java
 *
 * Created on Apr 23, 2014, 2:16:16 PM
 */
/**
 *
 * @author S500900
 */
public class NorthLot extends javax.swing.JFrame {

    /** Creates new form NorthLot */
    ArrayList<Integer> usedSpots;
    int[] possibleSpaces;

    public NorthLot() throws IOException {
        initComponents();
        ...
        for (int i = 271; i < 275; i++) {
            if (!usedSpots.contains(i)) {
                usedSpots.add(i);
            }
        }
        for (int i = 283; i < 287; i++) {
            if (!usedSpots.contains(i)) {
                usedSpots.add(i);
            }
        }
    ...
    public Map<String, Person> createMap(Person[] students) {
    ...
    private void updateSpots() {
        int[] possible_spaces = new int[378 - usedSpots.size()];
        int index = 0;
        for (int i = 1; i < 379; i++) {
            if (!usedSpots.contains(i)) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new NorthLot().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(NorthLot.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
